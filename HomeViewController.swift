...
//  Instagram1
//
//  Created by 越智三四郎 on 2022/07/01.
//
...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.likeButton.addTarget(self, action:#selector(handleButton(_:forEvent:)), for: UIControl.Event.touchUpInside)
            cell.komento.addTarget(self, action:#selector(handleCommentButton(_:forEvent:)), for: UIControl.Event.touchUpInside)
            return cell
        }
